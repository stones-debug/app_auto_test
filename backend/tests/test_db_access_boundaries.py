...
LEGACY_DB_ACCESS_ALLOWLIST: dict[str, set[str]] = {
    "sql": {
        "app/api/app_profiles/_shared.py",
        "app/api/app_profiles/overrides.py",
        "app/api/app_profiles/profiles.py",
        "app/api/app_profiles/releases.py",
        "app/api/app_profiles/skip_rules.py",
        "app/api/app_profiles/workspace.py",
        ...
        "app/services/profile_audit.py",
        "app/services/profile_resolver.py",
        "app/services/profile_resolver_load.py",
        "app/services/profile_revision.py",
    ...
    "session": {
        ...
        "app/services/profile_resolver.py",
        "app/services/profile_resolver_load.py",
        "app/services/profile_resolver_nodes.py",
        "app/services/profile_revision.py",
