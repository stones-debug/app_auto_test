...
class ErrorCode:
    ...
    EXECUTION_PREPARE_INVALID = "EXECUTION_PREPARE_INVALID"
    EXECUTION_RETRY_NOT_ALLOWED = "EXECUTION_RETRY_NOT_ALLOWED"
    EXECUTION_SNAPSHOT_NOT_READY = "EXECUTION_SNAPSHOT_NOT_READY"
    ELEMENT_IN_USE = "ELEMENT_IN_USE"
    # 模块树（用例模块 / 套件模块）：新增接口使用结构化错误码，
    # 存量模块接口仍用普通 HTTPException 字符串 detail，待后续统一。
    MODULE_NOT_FOUND = "MODULE_NOT_FOUND"
    MODULE_PARENT_INVALID = "MODULE_PARENT_INVALID"
    MODULE_SCOPE_MISMATCH = "MODULE_SCOPE_MISMATCH"
    MODULE_POSITION_INVALID = "MODULE_POSITION_INVALID"
