            ...
            lambda: app.on_message(
                {
                    ...
                    "suites": [{"execution_suite_id": 1001, "suite_id": None, "suite_name": "虚拟套件", "suite_order": 1, "is_virtual": True, "setup_steps": [], "cases": [{"execution_case_id": 2001, "case_id": 1, "case_name": "长执行", "steps_snapshot": [{"order": 1, "execution_step_id": 3001, "action": "sleep", "params": {"duration": 60}}], "assertions_snapshot": [], "elements_snapshot": {}}], "teardown_steps": []}],
                }
            )
        )
